        ...
        <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
          ...
          <div className="flex items-center space-x-4">
            ...
            <span className="text-dark-500 text-sm">
              © {currentYear} Juan Amorocho. {t.footer.rights}.
            </span>
          </div>
          ...
          <div className="flex items-center space-x-2 text-dark-500 text-sm">
            ...
            <span>+</span>
            <span className="text-primary-400">Astro</span>
            <span>+</span>
          ...
          <div className="flex items-center space-x-4">
            <a 
              ...
              className="text-dark-500 hover:text-accent-cyan transition-colors duration-300"
              aria-label="GitHub"
            >
