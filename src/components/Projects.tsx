      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          ...
          <article className="group relative overflow-hidden rounded-2xl bg-dark-900/50 border border-dark-700/50 hover:border-sky-500/30 transition-all duration-500">
            {/* Visual Header */}
            <div className="relative h-48 overflow-hidden bg-gradient-to-br from-sky-600/20 to-blue-600/20">
              <div className="absolute inset-0 grid-background opacity-30" />
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-sky-500 to-blue-600 flex items-center justify-center shadow-2xl shadow-sky-500/30 group-hover:scale-110 transition-transform duration-500">
                  <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="absolute top-4 left-4">
                <span className="px-3 py-1 text-xs font-semibold bg-sky-500/20 text-sky-300 rounded-full border border-sky-500/30">
                  💼 Freelance
                </span>
              </div>
            </div>
