export const translations = {
  es: {
    ...
    contact: {
      ...
      email: 'Email',
      emailPlaceholder: 'Ej: tu.correo@empresa.com',
      message: 'Mensaje',
      messagePlaceholder: 'Hola Juan, me gustaría hablar contigo sobre un proyecto de desarrollo web. Necesito...',
      send: 'Enviar mensaje',
      sending: 'Enviando...',
      successMessage: '¡Mensaje enviado! Te responderé pronto.',
      errorMessage: 'Error al enviar. Intenta de nuevo o contáctame directamente.',
  ...
  en: {
    ...
    contact: {
      ...
      email: 'Email',
      emailPlaceholder: 'E.g: your.email@company.com',
      message: 'Message',
      messagePlaceholder: 'Hi Juan, I would like to talk to you about a web development project. I need...',
      send: 'Send message',
      sending: 'Sending...',
      successMessage: 'Message sent! I will reply soon.',
      errorMessage: 'Error sending. Try again or contact me directly.',
